...
class Cpt_Register{
	public function __construct(){
		...
		add_action( 'init', array( $this, 'publications' ) );
	...
	function all_media() {
		$labels = array(
			'name'                  => _x( 'Medias', 'Post Type General Name', 'text_domain' ),
			'singular_name'         => _x( 'The Media', 'Post Type Singular Name', 'text_domain' ),
			'menu_name'             => __( 'The Media', 'text_domain' ),
			'name_admin_bar'        => __( 'Medias', 'text_domain' ),
			'archives'              => __( 'Medias Archives', 'text_domain' ),
			'attributes'            => __( 'Medias Attributes', 'text_domain' ),
			'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
			'all_items'             => __( 'All Items', 'text_domain' ),
			'add_new_item'          => __( 'Add New Item', 'text_domain' ),
			'add_new'               => __( 'Add New', 'text_domain' ),
